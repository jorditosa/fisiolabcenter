...
<main>
    ...
    <div class="row container-xl mx-auto">
        <div class="col-6 col-sm-4 col-md-3 p-1 p-md-3 animate__animated animate__fadeInLeft">
            ...
            <div class="especialista__description p-1">
                <span class="pt-3">Fisioterapeuta</span>
                <h3>Carles Morata</h3>
                <div class="text-start">
                    <span class="badge bg-primary text-white d-block mb-1">Fisioteràpia</span>
                    <span class="badge bg-info text-white d-block">Ecografia</span>
                </div>
            </div>
        </div>
        <div class="col-6 col-sm-4 col-md-3 p-1 p-md-3 animate__animated animate__fadeInLeft">
        ...
        <div class="col-6 col-sm-4 col-md-3 p-1 p-md-3 animate__animated animate__fadeInLeft">
            ...
            <div class="especialista__description p-1">
                <span class="pt-3">Fisioterapeuta</span>
                <h3>Pasqual Navarro</h3>
                <div class="text-start">
                    <span class="badge rounded bg-primary text-white d-block mb-1">Fisioteràpia</span>
                    <span class="badge rounded bg-info text-white d-block">Alt rendiment</span>
                </div>
            </div>
        </div>
...
<section class="serveis container-fluid py-1 px-0 m-0">
    <img src="build/img/wave_top.svg" alt="imagen top seccion" class="wave">
    ...
    <img src="build/img/wave_down.svg" alt="imagen bottom seccion" class="wave wave-down">
</section>
...
<!-- FIN SECCIONES SERVICIOS -->


<section class="hero__2 m-0 d-flex justify-content-center">
    <div class="text-center horaris py-3 mx-auto align-self-center">
        <h3 class="py-2 text-dark">El nostre horari</h3>
        <table class="text-dark">
            <tbody>
                <tr class="py-2">
                    <td>DILLUNS</td>
                    <td class="ps-3">8:30 AM - 21 PM</td>
                </tr>
                <tr class="py-2">
                    <td>DIMARTS</td>
                    <td class="ps-3">8:30 AM - 21 PM</td>
                ...
                <tr class="py-2">
                    <td>DISSABTE</td>
                    <td class="ps-3">AMB CITA PRÈVIA</td>
                </tr>
                <tr class="py-2">
                    <td>DIUMENGE</td>
                    <td class="ps-3">TANCAT</td>
                </tr>
            </tbody>
        </table>
    </div>
...
<section class="colaboradors py-5 bg-white my-3">
    <div class="row container-xl mx-auto">
        <div class="col-12 col-sm-7 col-lg-6 align-self-center colaboradors__head py-2 mx-auto">
            <h4 class="py-3 text-center text-md-start text-primary">Apostem per les col.laboracions locals</h4>
        </div>
        <div class="col-12 col-sm-5 col-lg-2 align-self-center mx-auto">
            <div id="carouselExampleSlidesOnly" class="carousel-fade slide" data-bs-ride="carousel">
                <div class="carousel-inner my-auto">
                    <div class="carousel-item">
                        <img src="build/img/clients/fisiolabcfvilanova.jpg" alt="logo fcvilanova" class="d-block w-100">
                    </div>
                    <div class="carousel-item active">
                        <img src="build/img/clients/deporunners_opt.webp" alt="logo deporunners" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                        <img src="build/img/clients/fisiolab-gedia.jpg" alt="logo gedia" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                        <img src="build/img/clients/fisiolab-sama.jpg" alt="logo sama" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                        <img src="build/img/clients/fisiolab-mercatdelcentre.jpg" alt="logo mercat" class="d-block w-100">
                    </div>
                </div>
            </div>
        </div>
